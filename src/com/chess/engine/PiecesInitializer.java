...
public class PiecesInitializer {
    ...
    private static void initializePawns(Board board, Player whitePlayer, Player blackPlayer){
        ...
        for (int col = 0; col < BoardUtils.NUM_OF_PAWNS / 2; col++) {
            ...
            Pawn whitePawn = new Pawn("P", Alliance.WHITE,
            ...
            Pawn blackPawn = new Pawn("P", Alliance.BLACK,
    ...
    private static void initializeRooks(Board board, Player whitePlayer, Player blackPlayer){
        ...
        Rook blackRookA8 = new Rook("R", Alliance.BLACK,
        ...
        Rook blackRookH8 = new Rook("R", Alliance.BLACK,
        ...
        Rook whiteRookA1 = new Rook("R", Alliance.WHITE,
        ...
        Rook whiteRookA8 = new Rook("R", Alliance.WHITE,
    ...
    private static void initializeKnights(Board board, Player whitePlayer, Player blackPlayer){
        ...
        Knight blackKnightB8 = new Knight("H", Alliance.BLACK,
        ...
        Knight blackKnightG8 = new Knight("H", Alliance.BLACK,
        ...
        Knight whiteKnightB1 = new Knight("H", Alliance.WHITE,
        ...
        Knight whiteKnightG1 = new Knight("H", Alliance.WHITE,
    ...
    private static void initializeBishops(Board board, Player whitePlayer, Player blackPlayer){
        ...
        Bishop blackBishopC8 = new Bishop("B", Alliance.BLACK,
        ...
        Bishop blackBishopF8 = new Bishop("B", Alliance.BLACK,
        ...
        Bishop whiteBishopC1 = new Bishop("B", Alliance.WHITE,
        ...
        Bishop whiteBishopF1 = new Bishop("B", Alliance.WHITE,
    ...
    private static void initializeQueens(Board board, Player whitePlayer, Player blackPlayer){
        ...
        Queen blackQueen = new Queen("Q", Alliance.BLACK,
        ...
        Queen whiteQueen = new Queen("Q", Alliance.WHITE,
    ...
    private static void initializeKings(Board board, Player whitePlayer, Player blackPlayer){
        ...
        King blackKing = new King("K", Alliance.BLACK,
        ...
        King whiteKing = new King("K", Alliance.WHITE,
